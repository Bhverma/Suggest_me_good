...
import "./Movies.css";
import {MoviesMain} from './MoviesMain.js'
import Divider from "./Divider";
import MovieCartoon from './Movie.gif';
...
export class Movies extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      Movies: this.Movies,
      MoviesMain : this.MoviesMain,
      MovieItem : [],
      Crime:this.Crime
    };
  }
  componentDidMount() {
    console.log("Hello this is compound ");
  ...
  suggestMovie = () => {
    ...
    console.log("Clicked suggestMovie")
    console.log(rand);
    
        this.setState ((this.state.MovieItem = MoviesMain[rand]))
        console.log(MoviesMain[rand]);
        console.log(this.state.MovieItem)
     this.setState((MovieCartoon = ""));
    
  
  }
  Crime = () => {
    console.log("clicked On Crime");
    const Crime = this.Movies.filter(Movies => {
      return Movies.Genre.includes('Crime') ;
    });
    console.log(Crime)
    this.setState  ((this.state.Movies = Crime));

  }
  Drama = () => {
    console.log("clicked On Drama");
    const Drama = this.Movies.filter(Movies => {
      return Movies.Genre.includes('Drama') ;
    });
    console.log(Drama)
    this.setState  ((this.state.Movies = Drama));

    
  } 
  Action = () => {
    console.log("clicked On Action");
    const Action = this.Movies.filter(Movies => {
      return Movies.Genre.includes('Action') ;
    });
    console.log(Action)
    this.setState  ((this.state.Movies = Action));

  }
  Fantasy = () => {
    console.log("clicked On Fantasy");
    const Fantasy = this.Movies.filter(Movies => {
      return Movies.Genre.includes('Fantasy') ;
    });
    console.log(Fantasy)
    this.setState  ((this.state.Movies = Fantasy));

  }
  Adventure = () => {
    console.log("clicked On Adventure");
    const Adventure = this.Movies.filter(Movies => {
      return Movies.Genre.includes('Adventure') ;
    });
    console.log(Adventure)
    this.setState  ((this.state.Movies = Adventure));
    ...
    return (
      <div>
        ...
        <div className="container">
          <img class="Move"src={MovieCartoon}></img>
          <div className=" my-2 mx-3 ">
            { 
              <ul>
                
                    <div className="col-md-4 my-3 container " >
                      <div>
                        <div className="container">
                        <h4 className="text-white my-3 Title">
                            <b>{this.state.MovieItem.title}</b>
                          </h4>
                          <img className = "ImageDesign"src={this.state.MovieItem.posterUrl}></img>
                      ...
                      <section>
                        <div  className="my-3">
                              ...
                              {this.state.MovieItem.plot}
                            </h6>
                          
                          
                            <pre className="text-warning">
                              {this.state.MovieItem.genres}
                              {this.state.MovieItem.year}
                            </pre>
                          
                          <pre className="text-warning">{this.state.MovieItem.director}{this.state.MovieItem.actors}</pre>
                          </div>
                          <hr className="Heading"></hr>
                      </section>
        ...
        <div class="d-flex justify-content-around ">
          ...
          <div className="p-2 bd-highlight ">
              <button
                type="button"
                class="btn btn-light text-white glow-on-hover mx-3 " onClick={this.Action}
              >
                Action
              </button>
            </div>
            ...
            <div className="p-2 bd-highlight ">
              <button
                type="button"
                class="btn btn-light text-white glow-on-hover mx-3 " onClick={this.Crime}
              >
                Crime
              </button>
            </div>
            <div className="p-2 bd-highlight ">
              <button
                type="button"
                class="btn btn-light text-white glow-on-hover mx-3 " onClick={this.Fantasy}
              >
                Fantasy
              </button>
            </div>
            <div className="p-2 bd-highlight ">
              <button
                type="button"
                class="btn btn-light text-white glow-on-hover mx-3 " onClick={this.Adventure}
              >
                Adventure
              </button>
            </div>
        ...
        <div className="container ">
          <div className="container">
            <h1 className="text-white">Popular_Movies</h1>
          </div>
        </div>
          ...
          <div className="container">
            <hr className="Heading"></hr>
            <div className="row">
              {this.state.Movies.map((key) => {
                
                return (
                  <div className="col-md-3 " key={key.imdbID}>
                    ...
                    <div class="container CardItem ">
                      <div class="card Glow">
                        ...
                        <div class="contentBx">
                          <b><p className="text-white">{key.Title}</p></b>
                          <div class="size">
                            <h3>{key.Genre}</h3>
                          </div>
                          <div class="color">
